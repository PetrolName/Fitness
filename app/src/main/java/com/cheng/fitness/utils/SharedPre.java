...
public final class SharedPre {
    ...
    public static <K extends Serializable, V extends Serializable> SharedPre putMap(String key, Map<K, V> value) {
        return getInstance().saveAsync(key, value, null);
    }
    ...
    public static <K extends  Serializable, V extends Serializable> Map<K, V> getMap(String key, Map<K, V> map){
        Map<K, V> value = getInstance().get(key, Map.class);
