package com.cheng.fitness.views.widget.bottomsheet;
...
import com.cheng.fitness.views.widget.bottomsheet.utils.DensityUtils;
...
public class BottomSheet extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configSheet();
        initContentLayout(items);
    }

    private void initContentLayout(List<MenuItem> items) {
        for (final MenuItem item:items) {
            TextView tvTitle = (TextView) LayoutInflater.from(context).inflate(R.layout.item_bottom_sheet, null);
